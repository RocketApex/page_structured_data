...
Gem::Specification.new do |spec|
  ...
  spec.description   = "PageStructuredData gives Rails applications a small page object and view partial for rendering page titles, basic meta tags, Open Graph tags, Twitter card tags, breadcrumb JSON-LD, article and forum post JSON-LD, Organization JSON-LD, WebSite JSON-LD, and public interaction statistics."
